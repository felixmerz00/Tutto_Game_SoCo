...
public class BonusStrategy300Test {
    ...
    void RolledNullTest() throws NoSuchFieldException,IllegalAccessException{
        ...
        BaseStrategy aStrat = new BonusStrategy300();
    ...
    void Rolled300with2Ones2FivesStopPuttingBack() throws NoSuchFieldException, IllegalAccessException {
        ...
        BonusStrategy aStrat = new BonusStrategy300();
    ...
    @Test
    void RolledTuttoTriplets() throws NoSuchFieldException, IllegalAccessException {
